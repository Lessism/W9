...
<section class="ui black segment text container">
	<bvo:form class="ui form" modelAttribute="bvo" action="${path}/board/update.w9" method="post">
		...
		<div class="ui center aligned container">
			<a class="absolute left f k r" href="${path}/board/prev.w9?prevno=${bvo.no}">Prev</a>
			<input class="ui black button f k r" type="submit" value="수정">
			<a class="ui red button f k r" href="${path}/board/delete.w9?no=${bvo.no}">삭제</a>
			<a class="ui button f k r" href="${path}/board/list.w9?page=1">목록</a>
			<a class="absolute right f k r" href="${path}/board/next.w9?nextno=${bvo.no}">Next</a>
		</div>
	</bvo:form>
</section>
